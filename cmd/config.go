...
func (c *Config) InfluxdbClient() (client.Client, error) {
	influx, err := client.NewHTTPClient(client.HTTPConfig{
		Addr:     c.Influxdb.Conn.Host,
		Username: c.Influxdb.Conn.User,
		Password: c.Influxdb.Conn.Passwd,
	})
	return influx, err
	//todo client ping test
}
